...
highlight_genes <- c("COG2271", "COGN0A789", "COG260NA2")
...
ggplot(long_matrix, aes(Gene2, Gene1, fill = interaction_type)) +
  geom_tile(color = "white") +
...
# Create the heatmap with ggplot2
ggplot(AC_long_matrix, aes(Gene2, Gene1, fill = interaction_type)) +
  geom_tile(color = "white") +
  ...
  labs(x = expression( ~ italic("P. aeruginosa")), 
       y = expression( ~ italic("E. coli")), 
       title = "Amikacin cefepime model gene interactions")
...
# Create the heatmap with ggplot2
ggplot(AL_long_matrix, aes(Gene2, Gene1, fill = interaction_type)) +
  geom_tile(color = "white") +
  ...
  labs(x = expression( ~ italic("P. aeruginosa")), 
       y = expression( ~ italic("E. coli")), 
       title = "Ampicillin Levofloxacin model gene interactions")
...
# Create the heatmap with ggplot2
ggplot(CL_long_matrix, aes(Gene2, Gene1, fill = interaction_type)) +
  geom_tile(color = "white") +
  ...
  labs(x = expression( ~ italic("P. aeruginosa")), 
       y = expression( ~ italic("E. coli")), 
       title = "Cefepime Levofloxacin model gene interactions")
